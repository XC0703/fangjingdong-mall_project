...
import useCommonAddressEffect from '../../effects/addressEffects'
...
export default {
  ...
  setup() {
    ...
    const handleAddClick = () => { router.push({ name: 'AddressUpdate'}) }
    const handleUpdateClick = (addressId)=> {router.push(`/addressUpdate/${addressId}`)}
